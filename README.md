...
1.) Install Arch and then Hyprland following the wiki pages for each.
2.) Run the run.sh script and then perform the instructions at the end of the script. 
3.) Run the install-dotfiles.sh script.
4.) Adjust the hyprland.conf monitor section and then the hyprpaper.conf file to suit your needs. 
5.) Reboot and Enjoy.

## Issues

This setup is not perfect and is liable to change.
Everything that the run.sh script installs is what i use daily.
